  ...
  return (
    <main className="relative z-10 min-h-screen pt-28 sm:pt-32 px-4 sm:px-6 pb-16 sm:pb-24">
      <section className="mx-auto max-w-4xl bento-card p-6 sm:p-10 text-center">
        <p className="text-xs tracking-[0.2em] sm:tracking-[0.3em] uppercase text-text-tertiary mb-4">
          404
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            href="/archive"
            className="px-6 py-3 border border-ink/20 text-xs font-bold uppercase tracking-widest hover:border-accent transition-colors"
          >
            Browse Archive
          </Link>
        </div>
